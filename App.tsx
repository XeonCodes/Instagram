    ...
    <Tab.Navigator screenOptions={{headerShown: false}}>
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: () => (
            <HomeSvg width={32} height={32} color={colors.text} />
          ),
        }}
        component={Home}
      />
      ...
      <Tab.Screen
        ...
        options={{
          tabBarShowLabel: false,
          tabBarIcon: () => (
            <SearchSvg width={32} height={32} color={colors.text} />
          ),
        }}
        component={Home}
      />
      ...
      <Tab.Screen
        ...
        options={{
          tabBarShowLabel: false,
          tabBarIcon: () => (
            <ReelsSvg width={32} height={32} color={colors.text} />
          ),
        }}
        component={Home}
      />
      ...
      <Tab.Screen
        ...
        options={{
          tabBarShowLabel: false,
          tabBarIcon: () => (
            <MessageSvg width={32} height={32} color={colors.text} />
          ),
        }}
        component={Home}
      />
      ...
      <Tab.Screen
        ...
        options={{
          tabBarShowLabel: false,
          tabBarIcon: () => (
            <UserSvg width={32} height={32} color={colors.text} />
          ),
        }}
        component={Home}
      />
